...
image_urls = [
    "https://i.postimg.cc/W3pDP3v9/d8d7c36684cdd93cc4b261b6787f2419.jpg",
    "https://i.postimg.cc/G3QBzvvZ/99a70d1b6808c7e41adfc753e4e32dea.jpg",
...
async def txt_handler(client: Client, m: Message):
    await bot.send_message(m.chat.id, text=(
        f"╔═══════════════◇◇◇═══════════════╗\n"
        f"        🦇 𝐖𝐀𝐑𝐑𝐈𝐎𝐑 𝐁𝐎𝐓 𝐂𝐎𝐌𝐌𝐀𝐍𝐃𝐒\n"
        f"╚═══════════════◇◇◇═══════════════╝\n\n"

        f"╭─────⪧ 𝐌𝐚𝐢𝐧 𝐅𝐞𝐚𝐭𝐮𝐫𝐞𝐬 ⪦─────╮\n"
        f"📡 /start  – 𝐁𝐨𝐭 𝐒𝐭𝐚𝐭𝐮𝐬 𝐂𝐡𝐞𝐜𝐤\n"
        f"🚀 /drm    – 𝐄𝐱𝐭𝐫𝐚𝐜𝐭 𝐟𝐫𝐨𝐦 .𝐭𝐱𝐭 (𝐀𝐮𝐭𝐨)\n"
        f"🔒 /y2t    – 𝐘𝐨𝐮𝐓𝐮𝐛𝐞 → .𝐭𝐱𝐭 𝐂𝐨𝐧𝐯𝐞𝐫𝐭𝐞𝐫\n"
        f"🔍 /t2t    – 𝐓𝐞𝐱𝐭 → .𝐭𝐱𝐭 𝐆𝐞𝐧𝐞𝐫𝐚𝐭𝐨𝐫\n"
        f"⛔ /stop   – 𝐂𝐚𝐧𝐜𝐞𝐥 𝐑𝐮𝐧𝐧𝐢𝐧𝐠 𝐓𝐚𝐬𝐤\n"
        f"╰────────────────────────────╯\n\n"

        f"╭───⪧ 𝐓𝐨𝐨𝐥𝐬 & 𝐒𝐞𝐭𝐭𝐢𝐧𝐠𝐬 ⪦───╮\n"
        f"📱 /cookies – 𝐔𝐩𝐝𝐚𝐭𝐞 𝐘𝐓 𝐂𝐨𝐨𝐤𝐢𝐞𝐬\n"
        f"⭐ /id      – 𝐆𝐞𝐭 𝐂𝐡𝐚𝐭/𝐔𝐬𝐞𝐫 𝐈𝐃\n"
        f"🔍 /info    – 𝐔𝐬𝐞𝐫 𝐃𝐞𝐭𝐚𝐢𝐥𝐬\n"
        f"📊 /logs    – 𝐕𝐢𝐞𝐰 𝐁𝐨𝐭 𝐀𝐜𝐭𝐢𝐯𝐢𝐭𝐲\n"
        f"╰────────────────────────────╯\n\n"

        f"🦇 𝐍𝐨𝐭𝐞:\n"
        f"• 𝐒𝐞𝐧𝐝 𝐚𝐧𝐲 𝐬𝐮𝐩𝐩𝐨𝐫𝐭𝐞𝐝 𝐥𝐢𝐧𝐤 𝐝𝐢𝐫𝐞𝐜𝐭𝐥𝐲\n"
        f"• 𝐒𝐮𝐩𝐩𝐨𝐫𝐭𝐬 𝐛𝐚𝐭𝐜𝐡 𝐩𝐫𝐨𝐜𝐞𝐬𝐬𝐢𝐧𝐠\n\n"

        f"➥ 𝐌𝐚𝐝𝐞 𝐁𝐲 : [𝐖𝐀𝐑𝐑𝐈𝐎𝐑 𝐁𝐎𝐓](https://t.me/bhanu_contact_bot) 💻\n"
        f"━━━━━━━━━━⊳◆⊲━━━━━━━━━━\n"
    ))              
            ...
            try:
                ...
                if "drive" in url:
                    ...
                    Show = f"🚀𝐏𝐫𝐨𝐠𝐫𝐞𝐬𝐬 » {progress:.2f}%\n┃\n" \
                           ...
                           f"╰━✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ [𝐖𝐀𝐑𝐑𝐈𝐎𝐑 𝐁𝐎𝐓](https://t.me/staystrongbros)"
